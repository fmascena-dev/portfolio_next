...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col bg-gray-950/80 text-white pt-8">
      <div className="flex flex-col mx-auto px-6 py-9 gap-10 lg:gap-5 lg:pt-6">
        <div className="max-w-5xl mx-auto flex gap-14">
            ...
            >
              ...
              <div className="flex flex-col items-center lg:flex-row gap-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className=" w-full lg:w-auto bg-[#00ffd5] text-gray-900 py-2 px-4 rounded-full flex items-center justify-center gap-2 hover:bg-[#00ffd5]/80 transition-colors duration-300"
                >
                  <Download size={20} />
                  Download
                </motion.a>
          ...
          >
            <div className="hidden md:block w-[350px] h-[430px] relative mx-auto">
              <motion.div
                // animate={{
                //   rotate: 360,
                //   scale: [1, 1.05, 1],
              ...
              <Image
                ...
                alt="My Avatar"
                fill
                className="hidden md:block object-cover rounded-full p-2"
              />
            </div>
          </motion.div>
        </div>
